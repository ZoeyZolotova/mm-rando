...
namespace MMR.Randomizer.Constants
{
    ...
    public static class MusicGroups
    {
        ...
        public enum Category : int
        {
            ...
            FairysFountain       = GreatFairysFountain, // Fallback Alias
            ZeldasTheme          = 0x129,
            RosaSistersTheme     = 0x12A,
            CuriosityShop        = 0x12C,
            MarineResearchLab    = CuriosityShop, // Fallback Alias
            GiantsTheme          = 0x12D,
            ...
            ZoraHall             = 0x136,
            BigEnemy             = 0x138,
            MinibossBattle       = BigEnemy,
            AstralObservatory    = 0x13A,
            SecretGrotto         = 0x13B,
            MilkBar              = 0x13C,
            WoodsOfMystery       = 0x13E,
            MysteryWoods         = WoodsOfMystery, // Fallback Alias
            HorseRace            = 0x140,
            GormanBrosTheme      = 0x142,
            WitchesTheme         = 0x143,
            KoumeAndKotakesTheme = WitchesTheme, // Fallback Alias
            ItemShop             = 0x144,
            OwlsTheme            = 0x145,
            KaeporaGaeborasTheme = OwlsTheme, // Fallback Alias
            MinigameShop         = 0x146,
            SwordSchool          = 0x150,
            FinalHours           = 0x157,
        ...
        public static readonly Dictionary<string, Category> CategoryDisplayNames = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Boss Battle",              Category.BossBattle },
            ...
            //{ "Miniboss Battle",          Category.MinibossBattle },
            ...
            // Ocarina of Time BGM Music Groups
            { "Overworld",         Category.Fields },
            { "Dungeon",           Category.Dungeons },
            { "Fight",             Category.Fights },
            { "CharacterTheme",    Category.CalmThemes },
            { "Outdoors",          Category.Fields },
            //{ "Indoors",           Category.Indoors },
            { "ChildDungeon",      Category.Dungeons },
            { "AdultDungeon",      Category.Dungeons },
            { "SmallFight",        Category.SmallEnemy },
            { "BigFight",          Category.BossEnemy },
            { "HeroTheme",         Category.ActionThemes },
            { "VillainTheme",      Category.ActionThemes },
            //{ "Fields",            Category.Fields },
            { "Town",              Category.Towns },
            { "Fun",               Category.Minigames },
            { "MagicalPlace",      Category.CalmThemes },
            //{ "House",             Category.House },
            { "SalesArea",         Category.ItemShop },
            { "WindmillHut",       Category.Indoors },
            { "AncientDungeon",    Category.Dungeons },
            { "MysticalDungeon",   Category.Dungeons },
            { "SpookyDungeon",     Category.Dungeons },
            { "BossFight",         Category.BossEnemy },
            { "FinalFight",        Category.MajorasWrath },
            { "HyruleField",       Category.TerminaField },
            { "LostWoods",         Category.WoodsOfMystery },
            { "GerudoValley",      Category.PiratesFortress },
            { "Market",            Category.Towns },
            { "KakarikoChild",     Category.Towns },
            { "KakarikoAdult",     Category.Towns },
            { "LonLonRanch",       Category.RomaniRanch },
            { "KokiriForest",      Category.SouthernSwamp },
            { "GoronCity",         Category.GoronShrine },
            { "ZorasDomain",       Category.ZoraHall },
            { "CastleCourtyard",   Category.MinigameTheme },
            //{ "HorseRace",         Category.HorseRace },
            { "Mini-game",         Category.MinigameTheme },
            { "ShootingGallery",   Category.MinigameShop },
            { "FairyFountain",     Category.GreatFairysFountain },
            { "TempleOfTime",      Category.HealingTheme },
            { "ChamberOfTheSages", Category.AstralObservatory },
            { "Shop",              Category.ItemShop },
            { "PotionShop",        Category.CuriosityShop },
            { "InsideDekuTree",    Category.SecretGrotto },
            { "DodongosCavern",    Category.SecretGrotto },
            { "JabuJabu",          Category.Dungeons },
            { "ForestTemple",      Category.WoodfallTemple },
            { "FireTemple",        Category.IkanaCastle },
            { "IceCavern",         Category.Snowhead },
            { "WaterTemple",       Category.GreatBayTemple },
            { "SpiritTemple",      Category.StoneTower },
            { "ShadowTemple",      Category.InvertedStoneTower },
            { "CastleUnderground", Category.Dungeons },
            { "CastleEscape",      Category.ActionThemes },
            { "Battle",            Category.SmallEnemy },
            { "MinibossBattle",    Category.BigEnemy },
            //{ "BossBattle",        Category.BossEnemy },
            { "FireBoss",          Category.BossEnemy },
            { "GanondorfBattle",   Category.MajorasMask },
            { "GanonBattle",       Category.MajorasWrath },
            { "TitleTheme",        Category.TitleDemo },
            { "ZeldaTheme",        Category.ZeldasTheme },
            { "SheikTheme",        Category.ZeldasTheme },
            { "DekuTree",          Category.CalmThemes },
            { "KaeporaGaebora",    Category.OwlsTheme },
            { "FairyFlying",       Category.ReunionTheme },
            { "GanondorfTheme",    Category.MajorasTheme },
            { "KotakeAndKoume",    Category.WitchesTheme },
            { "IngoTheme",         Category.GormanBrosTheme },

            // Ocarina of Time Fanfare Music Groups
            { "EventFanfare",      Category.EventFanfares },
            { "SongFanfare",       Category.ItemFanfares },
            { "ItemFanfare",       Category.ItemFanfares },
            { "SuccessFanfare",    Category.ClearFanfares },
            { "BigFanfare",        Category.OpenChest },
            //{ "GameOver",          Category.GameOver },
            { "WarpSong",          Category.SoaringTheme },
            { "UtilitySong",       Category.ItemFanfares },
            //{ "ItemGet",           Category.ItemGet },
            //{ "HeartContainerGet", Category.HeartContainerGet },
            { "SpiritStoneGet",    Category.TempleClearShort },
            //{ "HeartPieceGet",     Category.HeartPieceGet },
            { "MedallionGet",      Category.TempleClearLong },
            //{ "BossDefeated",      Category.BossDefeated },
            { "EponaRaceGoal",     Category.HorseRaceWin },
            { "EscapeFromRanch",   Category.EventSuccess },
            { "TreasureChest",     Category.OpenChest },
            { "MasterSword",       Category.SoaringTheme },
            { "DoorOfTime",        Category.TempleAppears },
            { "ZeldaTurnsAround",  Category.TruthRevealed },
            { "GanondorfAppears",  Category.EventFanfares },
            { "PreludeOfLight",    Category.EventFanfares },
            { "MinuetOfForest",    Category.EventFanfares },
            { "BoleroOfFire",      Category.EventFanfares },
            { "SerenadeOfWater",   Category.EventFanfares },
            { "RequiemOfSpirit",   Category.EventFanfares },
            { "NocturneOfShadow",  Category.EventFanfares },
            { "ZeldasLullaby",     Category.EventFanfares },
            { "EponasSong",        Category.EventFanfares },
            { "SariasSong",        Category.EventFanfares },
            { "SunsSong",          Category.EventFanfares },
            { "SongOfTime",        Category.EventFanfares },
